...
**POC_PARTIALLY_VALIDATED**。已完成范围、知识 metadata、工作流设计、40 条私有 Golden Set 与离线合同校验；当前环境未提供可用的 Dify 地址和应用 API Key，故未创建/发布 Knowledge 与 Workflow，也没有真实 API、检索、引用、时延或安全 Gate 指标。
...
- 尚未执行真实 Dify API：API 成功率、Schema、Hit@K、引用有效性、诊断正确性、拒答、安全升级、P50/P95 与 Token 均为未验证。
