export const caseConfig = {
  ...
  ], datasetSummary: "29 条 Golden Set 记录：28 条可执行、1 条 score=20 可达性静态检查、6 条 Critical Case；全部为 SIMULATED。", evidenceSource: "poc/reports/page-evidence.json · eval-summary.json · golden_cases.json" },
